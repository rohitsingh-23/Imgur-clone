...
myHeaders.append("Authorization", "Client-ID 5d8d33bce03b650");
...
function display(data) {
  ...
  function showData(data, parent) {
    ...
    data.map((item, i) => {
      ...
      let splitImg = image.split(".")[3];
      // console.log("split", splitImg)
      ...
      let info = document.createElement("div");
      info.innerHTML = `<div class="linkes-comment">
